...
type ColorType = "red" | "blue" | "green" | "yellow" | "brown" | "custom";
  ...
  <DrawerTrigger asChild>
    ...
    >
      <Settings />
        ...
        <DrawerContent className='min-w-[27%]'>
              ...
              <div className="space-y-6 p-4 pt-24">
                ...
                <div>
                  ...
                  <div className="flex gap-3 items-center">
                    {(["red", "blue", "green", "yellow", "brown"] as const).map((c) => (
                      <div
                        key={c}
                        onClick={() => setColor(c)}
                        className="border w-[15%] rounded-md p-2.5 cursor-pointer hover:ring-2 ring-blue-500/30"
                      >
                        <div
                          className={`w-full h-8 rounded-md ${colorMap[c].swatch}`}
                        />
                      </div>
                    ))}
                    ...
                    <div
                      ...
                      className={`border rounded-md p-2.5 cursor-pointer ${
                        color === "custom"
